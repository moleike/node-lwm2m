 ...
 */
exports.write = function(device, path, value, options, callback) {
  ...
  debug('Writing to %s in device [%s]', path, device.ep);
...
exports.remove = function(device, path, callback) { 
  var request = {
    host: device.address,
    port: device.port,
    method: 'DELETE',
...
exports.finish = function(device, callback) { 
  var request = {
    host: device.address,
    port: device.port,
    method: 'POST',
