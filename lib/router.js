...
Router.prototype.handle = function(req, res) {
  if (req.code === '0.00' && req._packet.confirmable && 
    ...
    debug('receiving message with code %s', req.code);
 ...
 */
Router.prototype.sendRequest = function(request) {
  var req = this.agent.request(request),
      rs = new Readable();
